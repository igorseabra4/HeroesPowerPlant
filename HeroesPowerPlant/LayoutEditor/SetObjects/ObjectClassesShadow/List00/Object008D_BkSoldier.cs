namespace HeroesPowerPlant.LayoutEditor
{
    public class Object008D_BkSoldier : SetObjectShadow
    {
        ...
        public BkSoldierWaitType Pos1_WaitType
        { //15
            get => (BkSoldierWaitType)ReadInt(60);
            set => Write(60, (int)value);
        }

        public float Pos1_WaitSec
        { //16
            get => ReadFloat(64);
            set => Write(64, value);
        }
        ...
        public BkSoldierWaitType Pos2_WaitType
        { //20
            get => (BkSoldierWaitType)ReadInt(80);
            set => Write(80, (int)value);
        }

        public float Pos2_WaitSec
        { //21
            get => ReadFloat(84);
            set => Write(84, value);
        }
