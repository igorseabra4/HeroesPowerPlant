namespace HeroesPowerPlant.LayoutEditor {
    public class Object0092_BkChaos : SetObjectShadow {
        ...
        public BkChaosShapeType StartingState { //7 ShapeType
            get => (BkChaosShapeType)ReadInt(28);
            set => Write(28, (int)value);
        }

        public int NumberOfChibi { //8
            get => ReadInt(32);
            set => Write(32, value);
        }

        public float BrokenPieceFlyDistance { //9
            get => ReadFloat(36);
            set => Write(36, value);
        }

        public float BrokenPieceFlyOffset { //10
            get => ReadFloat(40);
            set => Write(40, value);
        }

        public float CombineStartTime { //11
            get => ReadFloat(44);
            set => Write(44, value);
        }

        public float CombineTime { //12
            get => ReadFloat(48);
            set => Write(48, value);
        }
    }
