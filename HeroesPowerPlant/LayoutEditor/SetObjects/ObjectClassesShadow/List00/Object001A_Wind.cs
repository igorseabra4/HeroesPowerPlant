...
namespace HeroesPowerPlant.LayoutEditor
{
    public class Object001A_Wind : SetObjectShadow
    {
        ...
        {
            Matrix affectedTransformMatrix = Matrix.Scaling(Radius * 2, BoxTypeAirHeight * 2, AirHeightANDBoxTypeRadius * 2);
