...
namespace HeroesPowerPlant.ShadowCameraEditor
{
    public partial class ShadowCameraEditor : Form, IUnsavedChanges
    {
        ...
        private void buttonCopy_Click(object sender, EventArgs e)
        {
            ...
            var camera = ListBoxCameras.Items[CurrentlySelectedCamera] as ShadowCamera;
        ...
        {
            ShadowCamera newCamera;
            try
            {
                newCamera = new ShadowCamera(JsonConvert.DeserializeObject<ShadowCamera>(Clipboard.GetText()));
            }
            catch (Exception ex)
            {
